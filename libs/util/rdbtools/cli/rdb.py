...
from libs.util.rdbtools import RdbParser, JSONCallback, DiffCallback, MemoryCallback, ProtocolCallback, PrintAllKeys
...
Example : %prog --command json -k "user.*" /var/redis/6379/dump.rdb"""
    ...
    parser.add_option("-n", "--db", dest="dbs", action="append",
                      help="Database Number. Multiple databases can be provided. "
