...
from libs.util.rdbtools import RdbParser, JSONCallback, MemoryCallback
from libs.util.rdbtools.callbacks import encode_key
...
"""
    ...
    redis_key = args[0]
    print_memory_for_key(redis_key, host=options.host, port=options.port, db=options.db, password=options.password)
