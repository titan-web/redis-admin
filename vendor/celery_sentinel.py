...
(from https://gist.github.com/reclosedev/8460004)
To use it::
...
def register_celery_alias(alias="redis-sentinel"):
    BACKEND_ALIASES[alias] = "third.celery_sentinel.RedisSentinelBackend"
    TRANSPORT_ALIASES[alias] = "third.celery_sentinel.RedisSentinelTransport"
